  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="DateMe, your gateway to love and connection. Find your perfect partner, engage in meaningful conversations, and start your journey towards companionship today."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1575390130709-7b5fee2919e4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkYXRpbmd8ZW58MHx8fHwxNjk2MjM2MjMzfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@frame_media?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`René Ranisch`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`DateMe, your gateway to love and connection. Find your perfect partner, engage in meaningful conversations, and start your journey towards companionship today.`}
            </Text>
            <Box
